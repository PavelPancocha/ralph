    ...
    *,
    ...
    if plan_content:
        plan_eval_block = (
            "\n"
            "<plan-evaluation>\n"
            "The implementer followed this plan. If the implementation failed due to a\n"
            "fundamentally flawed plan (wrong approach, wrong files, incorrect codebase assumptions),\n"
