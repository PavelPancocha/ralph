...
export function buildSampleSpecTemplate(relFromSpecs: string): string {
  ...
  return [
    ...
    "<!-- GPT-5.5 spec style: describe the desired outcome, constraints, evidence, and validation. Avoid step-by-step implementation instructions unless the exact path is required. -->",
    "",
    "## Branch Instructions",
    "- Source branch: ``",
    "- Create branch: ``",
    ...
    "",
    "## Big Picture",
    "<!-- Optional: explain why this change matters and any product or architecture context the agent should preserve. -->",
    "",
    "## Goal",
    "Describe the end state in one or two sentences. Done means the user-visible or system-visible outcome is achieved, not merely that specific files were edited.",
    "",
    "## Scope (In)",
    "- Behavior, files, APIs, or docs Ralph may change.",
    "- Required compatibility or migration work, if any.",
    "",
    "## Boundaries (Out, No Overlap)",
    "- Non-goals, unrelated refactors, or adjacent areas Ralph must not touch.",
    "- Behaviors or public interfaces that must remain unchanged.",
    "",
    "## Constraints",
    "- Important technical, product, security, performance, or style constraints.",
    "- Prefer existing repo patterns unless this spec explicitly says otherwise.",
    "",
    "## Dependencies",
    "- None.",
    "",
    "## Required Reading",
    "- Concrete files, docs, issues, specs, or PRs the agent should inspect before planning.",
    "",
    "## Acceptance Criteria",
    "- Observable behavior or artifact that proves the outcome is satisfied.",
    "- Regression or compatibility expectation that must still hold.",
    "",
    "## Commit Requirements",
    "- Use the requested branch.",
    "",
    "## Verification (Fast-First)",
    "List targeted commands in the order Ralph should trust first. Prefer affected tests, type checks, lint/build checks, or a minimal smoke test.",
    "",
    "```bash",
    "",
    "```",
